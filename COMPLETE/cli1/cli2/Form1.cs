...
namespace cli2
{
    public partial class Form1 : Form
    {
        ...
        Socket client;
        EndPoint ep;
        byte[] nhanText, nhanPublicKey, nhanLength, nhanSKey;
        ...
        private void genKey_Click(object sender, EventArgs e)
        {
            ...
            txtkey.Text = Convert.ToBase64String(publicKey);
            ...
            textBox1.Text = Convert.ToBase64String(nhanPublicKey, 0, count1);


            byte[] secretKey02 = secretKey(nhanPublicKey);
            txtPri.Text = Convert.ToBase64String(nhanSKey, 0, count);
            ...
            //txtPri.Text = Convert.ToBase64String(rsa.ExportCspBlob(false));
            //txtkey.Text = Convert.ToBase64String(rsa.ExportCspBlob(true));

        }

        private void rncry_Click(object sender, EventArgs e)
        {
        ...
        private void decry_Click(object sender, EventArgs e)
        {
            ...
            //txtdecry.Text = finalen; ii

            //string time = dt;
            //string TextMaHoa = txtencry.Text;
            //string encryptedText = TextMaHoa;
            //string key = txtkey.Text;
            //string rawText = Decrypt(key, encryptedText, time);
            //txtdecry.Text = rawText;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //string allText = encryptedText + ";" + keyPad + ";" + textpad + ";" + txtfinal;
        ...
        private void txtDPAD_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtdecry_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtencry_TextChanged(object sender, EventArgs e)
        {
